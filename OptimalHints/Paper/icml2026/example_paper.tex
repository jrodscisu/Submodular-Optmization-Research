...
\twocolumn[
  \icmltitle{Submodular Maximization with Optimal Hints}
...
We consider the problem \emph{maximization of a nonnegative submodular function}. That is, given submodular function $f: 2^{V} \rightarrow \mathbb{R}_+$ find a set $S \subseteq V$ that maximizes $f(S)$. 
