...
\textbf{Predictions (Learning augmented ?).} 



\textbf{}

We will discuss and analyze how this greedy algorithm would perform if given an initial set of $S_{\ell}$ of $\ell$ elements from some optimal solution. In Section 3.1 we define what it means for an element to be part of an optimal solution. In Section 3.2 we go over the case where the $\ell$ elements are any elements from an optimal solution, and Section 3.3 covers the case where these elements are the best elements from an optimal solution. 

\section{Related work}

\section{Submodular Maximization with Optimal Hints}

\subsection{Optimal hints}

\subsection{any elements from the optimal solution}

\subsection{the "best" elements from the optimal solution}
